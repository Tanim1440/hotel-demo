...
const HotelCard = ({ room, index }) => {
    return (
        ...
        //     className="block max-w-70 w-full"
        // >
        //     <div className="relative rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0.05)]">
        ...
        //         {/* BADGE */}
        //         {index % 2 === 0 && (
        //             <p className="absolute top-3 left-3 px-3 py-1 text-xs bg-white text-gray-800 font-medium rounded-full z-10">
        //                 Best Seller
        //             </p>
        //         )}
        ...
        //                 <span className="px-4 py-2 text-sm font-medium border border-gray-300 rounded hover:bg-gray-50 transition-all">
        //                     Book Now
        //                 </span>
        //             </div>
        //         </div>
